...
args = parser.parse_args(['--server','10.211.6.12'])

ConnectionString = "DRIVER=MySQL ODBC 8.0 ANSI Driver;SERVER={1};DATABASE=zabbix;UID=joao.santana;PWD={0};OPTION=3;CHARSET=utf8mb4;".format(pwdins1, args.server)
